...
const accountsController = require('./api/common/accounts/accountsController');
...
app.use(expressMongoDb('mongodb://localhost:27017/anckr-crm'));
...
app.use(`${root}/accounts`, auth, accountsController);
